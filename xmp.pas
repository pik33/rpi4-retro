...
function xmp_create_context:Txmp_context; cdecl; external 'libxmp' name 'xmp_create_context';
procedure xmp_free_context(xmp_context:Txmp_context); cdecl; external 'libxmp' name 'xmp_free_context';
function xmp_test_module(a:Pchar;b:Pxmp_test_info):integer; cdecl; external 'libxmp' name 'xmp_test_module';
function xmp_load_module(a:Txmp_context; b:Pchar):integer; cdecl; external 'libxmp' name 'xmp_load_module';
procedure xmp_scan_module(a:Txmp_context);cdecl; external 'libxmp' name 'xmp_scan_module';
procedure xmp_release_module(a:Txmp_context);cdecl; external 'libxmp' name  'xmp_release_module';
function xmp_start_player(a:Txmp_context;b,c:integer):integer; cdecl; external 'libxmp' name 'xmp_start_player';
function xmp_play_frame(a:Txmp_context):integer; cdecl; external 'libxmp' name 'xmp_play_frame';
function xmp_play_buffer(a:Txmp_context; b:pointer; c,d:integer):integer; cdecl; external 'libxmp' name 'xmp_play_buffer';
procedure xmp_get_frame_info(a:Txmp_context; b:Pxmp_frame_info); cdecl; external 'libxmp' name 'xmp_get_frame_info';
procedure xmp_end_player(a:Txmp_context); cdecl; external 'libxmp' name 'xmp_end_player';
procedure xmp_inject_event(a:Txmp_context; b:integer;c:Pxmp_event); cdecl; external 'libxmp' name 'xmp_inject_event';
procedure xmp_get_module_info (a:Txmp_context;b:Pxmp_module_info); cdecl; external 'libxmp' name 'xmp_get_module_info';
function xmp_get_format_list:pointer; cdecl; external 'libxmp' name 'xmp_get_format_list';
function xmp_next_position(a:Txmp_context):integer; cdecl; external 'libxmp' name 'xmp_next_position';
function xmp_prev_position(a:Txmp_context):integer; cdecl; external 'libxmp' name 'xmp_prev_position';
function xmp_set_position(a:Txmp_context;b:integer):integer; cdecl; external 'libxmp' name 'xmp_set_position';
procedure xmp_stop_module(a:Txmp_context); cdecl; external 'libxmp' name 'xmp_stop_module';
procedure xmp_restart_module(a:Txmp_context);cdecl; external 'libxmp' name 'xmp_restart_module';
function xmp_seek_time(a:Txmp_context;b:integer):integer cdecl; external 'libxmp' name 'xmp_seek_time';
function xmp_channel_mute(a:Txmp_context;b,c:integer):integer;cdecl; external 'libxmp' name 'xmp_channel_mute';
function xmp_channel_vol(a:Txmp_context;b,c:integer):integer; cdecl; external 'libxmp' name 'xmp_channel_vol';
function xmp_set_player(a:Txmp_context;b,c:integer):integer; cdecl; external 'libxmp' name 'xmp_set_player';
function xmp_get_player(a:Txmp_context;b:integer):integer; cdecl; external 'libxmp' name 'xmp_get_player';
function xmp_set_instrument_path(a:Txmp_context; b:PChar):integer; cdecl; external 'libxmp' name 'xmp_set_instrument_path';
function xmp_load_module_from_memory(a:Txmp_context; b:pointer; c:integer):integer; cdecl; external 'libxmp' name 'xmp_load_module_from_memory';
function xmp_load_module_from_file(a:Txmp_context; b:pointer; c:integer):integer; cdecl; external 'libxmp' name 'xmp_load_module_from_file';
